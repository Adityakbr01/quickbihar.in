...
export const metadata: Metadata = {
  title: "Privacy Policy | QuickBihar.in",
  description:
    "How QuickBihar.in collects, uses, stores, and protects your personal information. Read our full privacy policy for the QuickBihar mobile app and website.",
