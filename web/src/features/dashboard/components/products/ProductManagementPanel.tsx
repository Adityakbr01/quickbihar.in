    ...
    <form onSubmit={submit} className="grid gap-4">
      ...
      >
        ...
        <div className="grid gap-3 md:grid-cols-4">
          ...
          <ProductField
            label="Product SKU"
            helper="Optional. Leave blank to generate automatically."
          >
            <Input
              value={sku}
      ...
      <ProductFormSection title="Pricing & GST">
        <div className="grid gap-3 md:grid-cols-4">
          <ProductField
            ...
            helper="Optional crossed-out price, for example 998."
          >
            <Input
              value={originalPrice}
      ...
      {variants.map((variant, index) => (
        ...
        >
          ...
          <ProductField
            ...
            helper="Leave blank to generate from product, size, and color."
          >
            <Input
              value={variant.sku || ""}
