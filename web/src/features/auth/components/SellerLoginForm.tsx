...
import { useSellerLogin, useSellerVerifyOTP } from "../hooks/useAuth";
...
export default function SellerLoginForm() {
  ...
  const { mutate: login, isPending: isLoggingIn } = useSellerLogin();
  const { mutate: verifyOtp, isPending: isVerifying } = useSellerVerifyOTP();
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-white/5 border-white/10 text-white placeholder:text-gray-500 focus:border-emerald-500 text-center tracking-widest text-lg transition-colors"
                  required
                />
              </div>
              <Button
