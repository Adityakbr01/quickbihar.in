...
router.get("/sellers/:id/insights", AdminController.sellerInsights);
...
router.get("/riders/:id/insights", AdminController.riderInsights);
router.get("/riders/:id", AdminController.riderDetails);
...
router.patch("/delivery/:deliveryId/payout-methods/:methodId/status", AdminController.reviewDeliveryPayoutMethod);
