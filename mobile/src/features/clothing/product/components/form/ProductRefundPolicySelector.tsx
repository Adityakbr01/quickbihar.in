...
import { useAdminRefundPolicies } from "@/src/features/common/refundPolicy/hooks/useRefundPolicies";
  ...
  return (
    <View style={styles.section}>
      ...
      <Text style={[styles.label, { marginBottom: 12 }]}>
        Select a policy for this product
      </Text>
      ...
      {refundPolicyId &&
        policies?.data?.find((p) => p._id === refundPolicyId) && (
          <View
            style={{
              marginTop: 12,
              padding: 12,
          ...
          >
            ...
            >
              {policies?.data?.find((p) => p._id === refundPolicyId)?.name} (
              {
                policies?.data?.find((p) => p._id === refundPolicyId)
                  ?.returnWindowDays
              }{" "}
